  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="font-bold text-2xl text-sp-white" style={{ fontFamily: 'var(--font-anton), Impact, sans-serif' }}>RESULTS</h1>
      </div>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        {totalPlayers > 0 && (
          <span className="text-gray-500 text-sm">Max {totalPlayers} votes per pin</span>
        )}
      </div>
      ...
      {loading ? (
        ...
        <p className="text-gray-600 text-center py-12">No pins or votes yet for this round.</p>
      ) : (
        <div className="flex flex-col gap-3">
          {results.map((pin, idx) => {
            ...
            return (
              ...
              >
                <div className="text-gray-600 font-bold text-lg w-6 text-center pt-0.5">
                  {idx + 1}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    ...
                    <span className="text-gray-500 text-xs shrink-0">{pin.cash_count}C / {pin.trash_count}T</span>
                  </div>
                </div>
